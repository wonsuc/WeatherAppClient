...
public class GlobalMenuAdapter extends ArrayAdapter<GlobalMenuAdapter.GlobalMenuItem> {
    ...
    private void setupMenuItems() {
        GlobalMenuItem startGlobalMenuItem = new GlobalMenuItem(R.drawable.ic_global_menu_cloud, "오늘 날씨");
        WeatherApplication weatherApplication = (WeatherApplication) getContext().getApplicationContext();
        weatherApplication.selectedGlobalMenuItem = startGlobalMenuItem;
        menuItems.add(startGlobalMenuItem);
        menuItems.add(new GlobalMenuItem(R.drawable.ic_global_menu_cloud, "현재 날씨"));
        menuItems.add(GlobalMenuItem.dividerMenuItem());
        menuItems.add(new GlobalMenuItem(0, "설정"));
